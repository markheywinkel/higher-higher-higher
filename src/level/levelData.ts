...
export const DEFAULT_LEVEL: LevelData = {
  ...
  platforms: [
    ...
    { id: "p63", x: 1390, y: 610, size: 4, type: "solid", material: "wood" },
    { id: "p64", x: 190, y: -590, size: 4, type: "moving-h", range: 120, speed: 70 },
    { id: "p65", x: 330, y: -500, size: 3, type: "moving-h", range: 120, speed: 70 },
    { id: "p66", x: 1350, y: -270, size: 3, type: "moving-h", range: 120, speed: 70 },
    { id: "p67", x: 1420, y: -330, size: 3, type: "moving-h", range: 120, speed: 70 },
    { id: "p68", x: 1520, y: -390, size: 3, type: "moving-h", range: 120, speed: 70 },
    { id: "p69", x: 1430, y: -450, size: 3, type: "moving-h", range: 120, speed: 70 },
    { id: "p70", x: 1320, y: -500, size: 3, type: "moving-h", range: 120, speed: 70 },
    { id: "p71", x: 1200, y: -540, size: 3, type: "moving-h", range: 120, speed: 70 },
    { id: "p72", x: 1070, y: -560, size: 2, type: "solid", material: "wood" },
  ],
